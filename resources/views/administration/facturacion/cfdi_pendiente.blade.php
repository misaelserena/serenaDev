		...
		<table class="table">
			...
			<tbody>
				@foreach($pending as $bill)
					<tr>
						<td class="align-middle">{{$bill->cfdiType->description}}</td>
						...
						<td class="align-middle"><a href="{{route('bill.cfdi.pending.stamp',$bill->idBill)}}" class="btn btn-blue"><span class="icon-pencil"></span></a></td>
					</tr>
				@endforeach
			</tbody>
		</table>
