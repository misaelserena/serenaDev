		...
		<div class="pdf-full">
			<div class="pdf-body">
				<div class="block-info">
					<table width="90%" style="margin: 0 auto">
						<tbody>
							<tr>
								...
								@endphp
								<td width="25%"><img src="{{ $base64 }}" class="logo"></td>
								<td width="75%">
					...
					@if($bill->type == 'N')
						<table style="border-collapse: separate;border-spacing: 0.1rem;width: 90%;margin: auto">
							<tbody>
								<tr>
				...
				<div class="block-info">
					<table class="request-info no-border centered-table">
						<tbody>
							<tr>
								<td width="50%">
									<table class="request-info table table-borderless">
										<tbody>
											<tr>
