...
<head>
	...
	<style type="text/css">
		...
		.proyecta-border
		{
			border: 1px solid #ed6d56 !important;
		}
	</style>
</head>
<body>
		...
		<div class="pdf-full">
			<div class="pdf-body">
				<div class="block-info">
					<table class="centered-table proyecta-border">
						<tbody>
							<tr>
								<td width="70%">
									<table class="request-info no-border centered-table" style="width: 80%;margin: 0 0 0 auto;">
										<tbody>
											<tr>
												<th>RFC emisor:</th>
												<td>{{$bill->rfc}}</td>
						...
						<tbody>
							...
							@if($bill->type == 'N')
								...
								<tr>
									...
									<td class="text-left">Fecha de inicio de relación laboral</td>
									<td class="normal">{{$bill->nominaReceiver->laboralDateStart}}</td>
								</tr>
								<tr>
									<td class="text-left">Antigüedad</td>
								...
								<tr>
									<td class="text-left">Tipo régimen</td>
									<td class="normal">{{$bill->nominaReceiver->nominaRegime->description}}</td>
									<td class="text-left">Número de empleado</td>
				...
				@if($bill->status == 1)
					<div class="block-info">
						<table style="margin: auto;width: 600px;max-width: 600px;">
							<tbody>
								<tr>
									<td colspan="4">Sello digital del CFDI</td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="4">Sello digital del SAT</td>
								</tr>
								<tr>
									<td align="left" colspan="4">
								...
								<tr>
									<td colspan="4">Cadena original</td>
								</tr>
								<tr>
