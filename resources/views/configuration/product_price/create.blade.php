			...
			<div class="card-body">
				...
				<div class="form-row">
					<div class="md-form col-md-6 mb-3">
						...
						<label for="price_purchase">Precio Compra</label>
						<input type="text" class="form-control" id="price_purchase" name="price_purchase" @if(isset($product)) value="{{ $product->price_purchase }}" @endif required>
					</div>
					<div class="md-form col-md-6 mb-3">
						<i class="fas fa-dollar-sign prefix"></i>
				...
				<div class="form-row">
					<div class="md-form col-md-6 mb-3">
						<i class="fas fa-dollar-sign prefix"></i>
						<label for="wholesale_price">Precio Venta Mayoreo</label>
