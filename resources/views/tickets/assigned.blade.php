...
@section('content')
	...
	{!! Form::open(['route' => 'tickets.assigned', 'method' => 'GET', 'id'=>'formsearch']) !!}
		<center>
		...
		<table class="table table-striped">
			...
			@foreach($tickets as $ticket)
				<tr>
					...
					<td>
						<a alt="Resolver Ticket" title="Resolver Ticket" href="{{ route('tickets.show.assigned',$ticket->idTickets) }}" class='btn follow-btn'><span class='icon-pencil'></span></a>
					</td>
