...
<div id="container-cambio" class="div-search">
	<form method='get' action='{{ route('report.breakdown.excel') }}' accept-charset='UTF-8' id='formsearch'>
		<center>
			...
			<div class="search-table-center">
				...
				<div id="form-excel">
					...
					<div class="search-table-center-row">
						...
						<div class="right-date">
							<p>
								<input type="text" name="mindate" step="1" class="input-text-date datepicker" placeholder="Desde" data-validation="required"> - <input type="text" name="maxdate" step="1" class="input-text-date datepicker" placeholder="Hasta" data-validation="required">
							</p>
						</div>
					</div>
					<center>
				...
				<div id="form-charts">
					...
					<div class="search-table-center-row">
						...
						<div class="right-date">
							<p><button type="button" class="btn follow-btn" id="showChartCircle"><img src="{{ asset('images/charts/graphic_circle.svg') }}" class="img-responsive" width="100"></button>
...
<script type="text/javascript"> 
	...
	.on('click','#showChartBar',function()
	{
		...
		idEnterprise	= $('.js-enterprise-charts option:selected').val();
