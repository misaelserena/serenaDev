...
@include('almacen.busqueda.opciones')
...
<script type="text/javascript">
  ...
  .on('click','.send-search', function() {
	...
	{
		concept         = $(this).parents('tr').find('.s_concept').val();
    idEnterprise    = $(this).parents('tr').find('.s_id_enterprise').val();
    place_id        = $(this).parents('tr').find('.s_place_id').val();
    account_id	    = $(this).parents('tr').find('.s_account_id').val();
		mindate			    = $(this).parents('tr').find('.s_mindate').val();
    maxdate 		    = $(this).parents('tr').find('.s_maxdate').val();
    place_location  = $(this).parents('tr').find('.s_place_location').val();
        ...
        lots.forEach( lot => {
          table += 	
            "<tr>"+
              ...
              "<input type='hidden' class='s_concept' value='" + lot['concept'] + "'>"+
              "</td>" +
              "<td>"+
                "" + (lot['place_location'] !== null ? lot['location']['place'] : "" ) + "" +
                "<input type='hidden' class='s_place_location' value='"+(lot['place_location'] !== null ? lot['place_location'] : "" )+"'>"+
                "<input type='hidden' class='s_id_enterprise' value='"+(idEnterprise ? idEnterprise : '')+"'>"+
                "<input type='hidden' class='s_place_id' value='"+(place_id ? place_id : '')+"'>"+
                "<input type='hidden' class='s_account_id' value='"+(account_id ? account_id : '')+"'>"+
                "<input type='hidden' class='s_mindate' value='"+(mindate ? mindate : '')+"'>"+
                "<input type='hidden' class='s_maxdate' value='"+(maxdate ? maxdate : '')+"'>"+                
              "</td>"+
              "<td>" +
