...
class User extends Authenticatable
{
   use Notifiable;
    ...
    protected $fillable = [
        'id','name', 'last_name', 'scnd_last_name', 'gender', 'phone', 'extension', 'email', 'status', 'enterprise_id', 'area_id', 'departament_id', 'position', 'cash', 'cash_amount', 'sys_user', 'active','notification'
    ];
